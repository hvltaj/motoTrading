...
class MotoSellerGui extends JFrame {	
	...
	private JTextField titleField, priceField, sizeField, yearField;
	
	MotoSellerGui(MotoSellerAgent a) {
		super(a.getLocalName());
		
		myAgent = a;
		//Dodanie okienek do wprowadzania danych
		JPanel p = new JPanel();
		...
		addButton.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				try {
                    // utworzenei stringow z danych zebranych z okienek
		...
		// Agent sie zamyka kiedy zamknie sie okienko	
